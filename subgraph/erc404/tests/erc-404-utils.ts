...
export function createERC1155SetTransferExemptEvent(
  account: Address,
  exempt: boolean
): ERC1155SetTransferExempt {
  let erc1155SetTransferExemptEvent = changetype<ERC1155SetTransferExempt>(
    newMockEvent()
  )

  erc1155SetTransferExemptEvent.parameters = new Array()

  erc1155SetTransferExemptEvent.parameters.push(
    new ethereum.EventParam("account", ethereum.Value.fromAddress(account))
  )
  erc1155SetTransferExemptEvent.parameters.push(
  ...
  return erc1155SetTransferExemptEvent
}
